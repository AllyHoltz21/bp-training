(() => {
  ...
  // Quick airy "fffshh" of air on each pump — quiet.
  function playPumpSound() {
    ...
    hp.type = 'highpass';
    hp.frequency.value = 600; // strip low rumble so it reads as "air", not "ocean"
    const bp = audioCtx.createBiquadFilter();
    bp.type = 'bandpass';
    bp.Q.value = 0.6;
    bp.frequency.setValueAtTime(1400, t);
    bp.frequency.linearRampToValueAtTime(2200, t + 0.08);
    bp.frequency.linearRampToValueAtTime(1000, t + 0.28);
    const g = audioCtx.createGain();
